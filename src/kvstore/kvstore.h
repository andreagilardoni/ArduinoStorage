...
public:
    ...
    /**
     * @brief templated method that puts a value of a certaint type T
    ...
    /**
     * @brief templated method that gets a value of a certaint type T. If it doesn't exist in the store a
