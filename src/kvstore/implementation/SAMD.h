...
// template<>
// KVStoreInterface<const char*>::reference<const char*> SAMDKVStore::get<const char*>(const key_t& key, const char* defaultValue) {
//     return reference<const char*>(key, WiFiDrv::prefGet(key, PT_STR, (uint8_t*)value, maxLen), *this);
// }
